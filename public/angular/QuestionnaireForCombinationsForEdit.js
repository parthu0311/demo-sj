'use strict';
angular.module('app')
    .controller('QuestionnaireForCombinationsForEdit', function($rootScope,$scope,$location,$resource,$timeout,$http,$compile) {
        $scope.image_array = [];
            ...
            if($el.hasClass('TextBox') == true || $el.hasClass('TextInputNumber') == true){
                ...
                /*config += Tooltip_html(Tooltip);*/
                    ...
                    $el.find('.radio-group input').each(function () {
                        var temp = {};
                        temp['value_id'] = $(this).data('value_id')?$(this).data('value_id'):"";
                        temp['val'] = $(this).val();
            ...
            $(".btn-success").off().on('click',function () {
                ...
                if($el.hasClass('TextBox') == true || $el.hasClass('TextInputNumber') == true) {
                    ...
                    $('.tConfig ol input').each(function () {
                        ...
                        var value_id = $(this).data('value_id')?$(this).data('value_id'):"";

                        html += '<div class="radio-inline">';
                        html += '<input type="radio" '+is_check+' value="'+$(this).val()+'" class="" name="'+name+'" data-value_id="'+value_id+'">';
                    ...
                    $('.tConfig ol input').each(function () {
                        ...
                        html += '<input type="checkbox" '+is_check+' value="'+$(this).val()+'" class="" name="'+name+'" data-value_id="'+value_id+'">';
                        html += '<label>'+$(this).val()+'</label>';
                        html += '</div>';
                    });
                    ...
                    $('.tConfig ol input').each(function () {
                        ...
                        var value_id = $(this).data('value_id')?$(this).data('value_id'):"";
                        html += '<option value="'+$(this).val()+'" '+is_check+' data-value_id="'+value_id+'">'+$(this).val()+'</option>';
        ...
        cities.initialize();
        $("#Main_div_dropzone .form-group").find('.tg_input').each(function () {
            var eltg = $("#"+$(this).attr("id"));
        ...
        $(document).on("click", "#FromSubmit", function(ev) {
            ...
            if(error == 0){
                ...
                fiels['field_label_id'] = $(this).data('field_label_id');
                var is_required = 'No';
                ...
                if($(this).hasClass('TextInput') == true){
                    ...
                    $(this).find('input[type=radio]').each(function (key,val) {
                        ...
                        temp_val[key] = {
                            'value_id':$(this).data('value_id')?$(this).data('value_id'):"",
                            'value':$(this).val(),
                            'is_ckecked': checked
                        };
                    });
