...
@section('title', 'Suril Jain - Collection Product List')
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Collection Product List For : <strong>{{$HomeCollection->collection_for}}</strong>
            </h1>
            <ol class="breadcrumb">
                <li><a href="{{ url('/admin/dashboard') }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                <li><a href="{{ url('/admin/home-collection-list') }}">Home Collection List </a></li>
                <li class="active">Collection Product List</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        <div class="box-header">
                            <h3 class="box-title">Collection Product List For : <strong>{{$HomeCollection->collection_for}}</strong></h3>
                        </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        var activeInactiveAjaxSource = '/admin/actInactProductCollectionStatus';
        ...
        $(document).ready(function () {
            dTable = $('#ProductList').dataTable({
                ...
                ajax: {
                    url: '/admin/CollectionProductListAjax/',
                    data: function (d) {
        ...
        function removeFromCollection(mode, ids) {
            ...
            if (ids != '') {
                if (confirm("Are you sure you want to remove?")) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/admin/removeProductFromCollection",
