...
@section('title', 'Suril Jain - Edit Home Collection')
@section('content')
                    ...
                    <div class="col-xs-12">
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border">
                                <h3 class="box-title"> Edit Home Collection</h3>
                            </div>
                            @if (count($errors) > 0)
                            ...
                            <div class="box-body" style="padding: 15px;">
                                ...
                                <form role="form" id="brandEditPost" method="post" action="{{ url('/admin/HomeCollectionEditPost/'.$HomeCollection->id) }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="box-body">
                                        <div class="row">
                                            <input type="hidden" name="old_img" value="{{$HomeCollection->image}}">

                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    <label>Home Collection For <span class="asterisk red">*</span></label>
                                                    <input class="form-control" placeholder="Home Collection For" type="text" name="collection_for" value="{{$HomeCollection->collection_for}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Home Collection Summery" type="text" name="collection_summery" value="{{$HomeCollection->collection_summery}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" style="width: 100%;" name="status">
                                                        ...
                                                        <option {{ $HomeCollection->status == 'Active' ? 'selected="selected"' : '' }} value="Active">Active</option>
                                                        <option {{ $HomeCollection->status == 'Inactive' ? 'selected="selected"' : '' }} value="Inactive">Inactive</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <img src="{{asset('uploads/collection_image').'/'.$HomeCollection->image}}"  class="img-responsive" height="386" width="270">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    reader.onload = function (e) {
                        ...
                        image.onload = function () {
                            ...
                            if (height != 386 || width != 270) {
                                alert("Height and Width must 386px * 270px.");
                                 $("#image_banner").val("");
                                return false;
                            }
