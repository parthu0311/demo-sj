...
@section('title', 'Suril Jain - Manage Product Category')
    ...
    <section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group nomargin">
                                ...
                                <div class="" id="sername"><span class="filter_column filter_text">
                                         <input type="text" class="search_init text_filter form-control" name="name" id="name" placeholder="Search Category Name"></span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row contentpanel">
            <div class="col-xs-12 text-right margin-bottom">
                ...
                <?php
                if (Helper::checkActionPermission('admin','product-category-create')) { ?>
                    <a href="{{ url('/admin/product-category-create') }}"><button class="btn btn-primary" type="button">Add</button></a>
                <?php } ?>
            </div>
        </div>
...
<script type="text/javascript">
    var selected = [];
    var deleteAjaxSource = '<?php echo (Helper::checkActionPermission('admin','deleteProCate')) ? 'deleteProCate' : ''; ?>';
    var activeInactiveAjaxSource = '<?php echo (Helper::checkActionPermission('admin','actInactProductCategoryStatus')) ? 'actInactProductCategoryStatus' : ''; ?>';
    ...
    $(document).ready(function () {
         dTable = $('#CategoryList').dataTable({
            ...
            ajax: {
                url: '/admin/productCategoryList/',
                data: function (d) {
                    d.id = $('input[name=id]').val();
                    /*d.parent_id = $('input[name=parent_id]').val();*/
            ...
            aoColumnDefs: [
                ...
                },
                {
                    "mRender": function (data, type, row) {
                        ...
                        if (addEditSource) {
                            html += '<a href="' + addEditSource + '/' + row.id + '" class="btn bg-olive fa fa-edit" title="Edit"> Edit & Manage</a>&nbsp;&nbsp;';
                        }
    ...
    $('#CategoryList_paginate ul li').on('click', function () {
