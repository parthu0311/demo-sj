...
@section('title', 'Suril Jain - Manage Home Slider List')
    ...
    <section class="content">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group nomargin">
                                ...
                                <div class="" id="serproduct_brand_code"><span class="filter_column filter_text">
                                        <input type="text" class="search_init text_filter form-control" name="name" id="name" placeholder="Search Slider Name"></span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row contentpanel">
            <div class="col-xs-12 text-right margin-bottom">
                ...
                <?php
                if (Helper::checkActionPermission('admin','home-slider-create')) { ?>
                    <a href="{{ url('/admin/home-slider-create') }}"><button class="btn btn-primary" type="button">Add Home Slider</button></a>
                <?php } ?>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var deleteAjaxSource = '<?php echo (Helper::checkActionPermission('admin','deleteHomeSlider')) ? 'deleteHomeSlider' : ''; ?>';
    var activeInactiveAjaxSource = '<?php echo (Helper::checkActionPermission('admin','actInactSliderStatus')) ? 'actInactSliderStatus' : ''; ?>';
    var addEditSource = '<?php echo (Helper::checkActionPermission('admin','home-slider-edit')) ? '/admin/home-slider-edit' : ''; ?>';
            ...
            aoColumnDefs: [
                ...
                },
                {
                    "mRender": function (data, type, full) {
                        ...
                        return '<img  class="img-responsive" src="{{asset('uploads/banner_image')}}/' + data + '"></img> ';
                    },
                    "aTargets": [2]
                },
                /*{
