...
@section('title', 'Suril Jain - Create Home Slider')
@section('content')
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Create Home Slider</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-body" style="padding: 15px;">
                                ...
                                <form role="form" id="HomeSliderCreatePostData" method="post" action="{{ url('/admin/HomeSliderCreatePostData') }}" enctype='multipart/form-data'>
                                    {{ csrf_field() }}
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Home Slider Name" type="text" name="name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Home Slider URL" type="text" name="url">
                                                </div>
                                            </div>
