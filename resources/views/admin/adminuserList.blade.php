    ...
    <section class="content">
        ...
        <div class="row contentpanel">
            <div class="col-xs-12 text-right margin-bottom">
                ...
                <?php 
                if (Helper::checkActionPermission('admin','createAdminUser')) { ?>
...
<script type="text/javascript">
    ...
    var addEditSource = '<?php echo (Helper::checkActionPermission('admin','editadminUser')) ? '/admin/editadminUser' : ''; ?>';
    //var addEditSource = '/admin/editadminUser';
    var deleteAjaxSource = '<?php echo (Helper::checkActionPermission('admin','delete')) ? '/admin/delete' : ''; ?>';
    var activeInactiveAjaxSource = '<?php echo (Helper::checkActionPermission('admin','activeInactiveStatus')) ? '/admin/activeInactiveStatus' : ''; ?>';
         ...
         dTable = $('#AdminUserList').dataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.email_address = $('input[name=email_address]').val();
