...
@section('title', 'Suril Jain - Manage Questionnaire Type List')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Filter Type List</li>
        </ol>
    </section>
    ...
    <section class="content">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group nomargin">
                                ...
                                <div class="" id="sercollection_type"><span class="filter_column filter_text">
                                        <input type="text" class="search_init text_filter form-control" name="questionnaire_type" id="questionnaire_type" placeholder="Search Filter Type"></span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row contentpanel">
            <div class="col-xs-12 text-right margin-bottom">
                ...
                <?php
                if (Helper::checkActionPermission('admin','collection-for-combinations')) { ?>
                    <a href="{{ url('/admin/collection-for-combinations') }}"><button class="btn btn-primary" type="button">Add Filter</button></a>
                <?php } ?>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary box-solid">
                    <div class="box-header">
                        <h3 class="box-title">Filter Type List</h3>
                    </div>

                    <div class="box-body">
						<div class="table-responsive">
							<table id="CombinationsList" class="table table-bordered table-striped">
								<thead>
									<tr>
                                        <th></th>
										<th>Filter Type</th>
...
<script type="text/javascript">
    ...
    var deleteAjaxSource = '<?php echo (Helper::checkActionPermission('admin','deletecollection')) ? 'deletecollection' : ''; ?>';
    var activeInactiveAjaxSource = '<?php echo (Helper::checkActionPermission('admin','activeInactivecollectionStatus')) ? 'activeInactiveQuestionnaireStatus' : ''; ?>';
    var addEditSource = '<?php echo (Helper::checkActionPermission('admin','collection-type-edit')) ? '/admin/collection-type-edit' : ''; ?>';

    function showMessage(){
       return '<div id="load" style="display: block"></div>';
    }
    $(document).ready(function () {
         dTable = $('#CombinationsList').dataTable({
            ...
            ajax: {
                url: '/admin/collectionList/',
                data: function (d) {
                    d.questionnaire_type = $('input[name=questionnaire_type]').val();
