...
@section('title', 'Suril Jain - Edit Filter')
@section('content')

    <div ng-controller="QuestionnaireForCombinationsForEdit">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ url('/admin/collection-type-list') }}">Filter List </a></li>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-primary box-solid">
                            ...
                            <div class="box-body" style="padding: 15px;">
                                ...
                                <form role="form" id="FormControlQuestionnaire" method="post" action="{{ url('/admin/collectionForCombinations/'.$Questionnaire->id) }}">
                                    {{ csrf_field() }}
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Questionnaire Type" type="text" name="questionnaire_type" value="{{$Questionnaire->questionnaire_type}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" style="width: 100%;" name="status">
                                                        ...
                                                        <option {{ $Questionnaire->status == 'Active' ? 'selected="selected"' : '' }} value="Active">Active</option>
                                                        <option {{ $Questionnaire->status == 'Inactive' ? 'selected="selected"' : '' }} value="Inactive">Inactive</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <form role="form">
                                                ...
                                                <div class="form-group draggable MultiSelect-tag-btn cstm-frmgrp">
                                                    ...
                                                    <div class="main-div" style="display: none">
                                                        ...
                                                        <input type="text" class="form-control tg_input" id="tag-input-1" placeholder="Add colors, pressing 'Enter between each one" value=""/>
                                                        <span class="text-danger pull-right"></span>
                                                    </div>
                                                </div>
                                                    ...
                                                    @if(isset($data) && !empty($data))
                                                        ...
                                                        @foreach($data as $key=>$val)
                                                            ...
                                                            @elseif($val['field_type'] == 'Radio-btn')
                                                                <div class="form-group redio Radio-btn  ui-draggable" style="cursor: move" data-field_label_id="{{$val['id']}}">
                                                                    <div  class="main-div">
                                                                            <textarea style="display: none;"
                                                                                      data-is_show_tooltip="<?php if($val['is_show_tooltip'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                                                      data-is_show_filter="<?php if($val['is_show_filter'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                                                      class="textarea-hidden">{{$val['field_Tooltip']}}</textarea>
                                                                        <label for="label">{{$val['field_label']}}</label><span class="is_required"><?php if($val['is_required'] == 'Yes'){ echo '*'; } ?></span>
                                                                        <div class="radio-group">
                                                            ...
                                                            @elseif($val['field_type'] == 'CheckBox-btn')
                                                                <div class="form-group CheckBox-btn  ui-draggable" style="cursor: move" data-field_label_id="{{$val['id']}}">
                                                                    <div  class="main-div">
                                                                            <textarea style="display: none;"
                                                                                      data-is_show_tooltip="<?php if($val['is_show_tooltip'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                                                      data-is_show_filter="<?php if($val['is_show_filter'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                            ...
                                                            @elseif($val['field_type'] == 'Select-btn')
                                                                <div class="form-group Select-btn  ui-draggable" style="cursor: move" data-field_label_id="{{$val['id']}}">
                                                                    <div  class="main-div">
                                                                            <textarea style="display: none;"
                                                                                      data-is_show_tooltip="<?php if($val['is_show_tooltip'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                                                      data-is_show_filter="<?php if($val['is_show_filter'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                                        ...
                                                                        <select id="select-edit-{{$key}}" name="select-edit-{{$key}}" class="form-control basic-single">
                                                                            ...
                                                                            @foreach($val['value'] as $single)
                                                                                ...
                                                                                <?php if($single['is_ckecked'] == "Yes"){echo "selected"; } ?> data-value_id="{{$single['id']}}">{{$single['value']}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                        <span class="text-danger pull-right"></span>
                                                                    </div>
                                                            ...
                                                            @elseif($val['field_type'] == 'MultiSelect-btn')
                                                                <div class="form-group MultiSelect-btn ui-draggable" style="cursor: move" data-field_label_id="{{$val['id']}}">
                                                                    <div class="main-div" >
                                                                            <textarea class="textarea-hidden"
                                                                                      data-is_show_tooltip="<?php if($val['is_show_tooltip'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                                                      data-is_show_filter="<?php if($val['is_show_filter'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                                        ...
                                                                        <select id="select-edit-{{$key}}" name="multiselect-edit-{{$key}}-[]" id="multiselect-edit-{{$key}}" class="form-control Mselect2 Mselect2-edit" multiple>
                                                                            ...
                                                                            @foreach($val['value'] as $single)
                                                                                <option value="{{$single['value']}}"
                                                                                <?php if($single['is_ckecked'] == "Yes"){echo "selected"; } ?> data-value_id="{{$single['id']}}">
                                                                                    {{$single['value']}}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                ...
                                                                @elseif($val['field_type'] == 'MultiSelect-tag-btn')
                                                                    <div class="form-group MultiSelect-tag-btn ui-draggable" style="cursor: move" data-field_label_id="{{$val['id']}}">
                                                                        <div class="main-div" >
                                                                            <textarea class="textarea-hidden"
                                                                                      data-is_show_tooltip="<?php if($val['is_show_tooltip'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                                                      data-is_show_filter="<?php if($val['is_show_filter'] == 'Yes'){ echo 'True'; }else{ echo 'false'; } ?>"
                                                                            ...
                                                                            <?php $temp = []; ?>
                                                                            @foreach($val['value'] as $single)
                                                                                <?php array_push($temp, $single['value']); ?>
                                                                            @endforeach
                                                                            <input type="text" class="form-control tg_input"
                                                                                   id="TagInput-edit-{{\App\Http\Helper::randomString()}}"
                                                                                   placeholder="Add colors, pressing 'Enter between each one"
                                                                                   value="{{implode(',',$temp)}}"
                                                                                   Name="TextInput-edit-{{\App\Http\Helper::randomString()}}"
                                                                                   >
                                                                            <span class="text-danger pull-right"></span>
                                ...
                                <div class="box-footer">
                                    <a href="{{ url('/admin/collection-type-list') }}"><button class="btn btn-default pull-right" style="margin:0 0 0 5px" type="button">Cancel</button></a>
...
@push('scripts')
    ...
    <script src="{{ asset('angular/QuestionnaireForCombinationsForEdit.js') }}"></script>
