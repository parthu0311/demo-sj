...
@section('title', 'Suril Jain - Tag Collection Product List')
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Tag Collection Product List For : <strong>{{$HomeCollection->name}}</strong>
            </h1>
            <ol class="breadcrumb">
                <li><a href="{{ url('/admin/dashboard') }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                <li><a href="{{ url('/admin/home-tag-collection-list') }}">Home Tag Collection List </a></li>
                <li class="active">Tag Collection Product List</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        <div class="box-header">
                            <h3 class="box-title">Tag Collection Product List For : <strong>{{$HomeCollection->name}}</strong></h3>
                        </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        var activeInactiveAjaxSource = '/admin/actInactProductTagCollectionStatus';
        ...
        $(document).ready(function () {
            dTable = $('#ProductList').dataTable({
                ...
                ajax: {
                    url: '/admin/TagCollectionProductListAjax/',
                    data: function (d) {
                        ...
                        d.collection_id = '<?php echo $HomeCollection->id; ?>';
                    }
                },
                columns: [
        ...
        function AddInCollection(status, ids, mode) {
            ...
            if (ids != '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "/admin/add_in_tag_collection",
                    // data: "id=" + ids + "&status=" + status + "&mode=" + mode + "&_token=<?php echo csrf_token(); ?>",
                    data: "id=" + ids + "&status=" + status + "&collection_id=<?php echo $HomeCollection->id; ?>",
                    headers: {
        ...
        function removeFromCollection(mode, ids) {
            ...
            if (ids != '') {
                if (confirm("Are you sure you want to remove?")) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/admin/removeProductFromTagCollection",
                        data: {"id": ids,"collection_id":'<?php echo $HomeCollection->id; ?>'},
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        success: function (data) {
