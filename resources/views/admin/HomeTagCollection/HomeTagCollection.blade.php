...
@section('title', 'Suril Jain - Manage Home Tag Collection List')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Home Tag Collection List
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin/dashboard') }}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li class="active">Home Tag Collection List</li>
        </ol>
    </section>
    ...
    <section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group nomargin">
                                <label class="control-label">Tag Collection Name</label>
                                <div class="" id="serproduct_brand_code"><span class="filter_column filter_text">
                                        <input type="text" class="search_init text_filter form-control" name="name" id="name" placeholder="Search Collection Name"></span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row contentpanel">
            <div class="col-xs-12 text-right margin-bottom">
                ...
                <?php
                if (Helper::checkActionPermission('admin','home-tag-collection-create')) { ?>
                    <a href="{{ url('/admin/home-tag-collection-create') }}"><button class="btn btn-primary" type="button">Add Home Tag Collection</button></a>
                <?php } ?>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary box-solid">
                    <div class="box-header">
                        <h3 class="box-title">Home Tag Collection List</h3>
                    </div>
...
<script type="text/javascript">
    ...
    var deleteAjaxSource = '<?php echo (Helper::checkActionPermission('admin','deleteHomeTagCollection')) ? 'deleteHomeTagCollection' : ''; ?>';
    var activeInactiveAjaxSource = '<?php echo (Helper::checkActionPermission('admin','actInactHomeTagCollectionStatus')) ? 'actInactHomeTagCollectionStatus' : ''; ?>';
    var addEditSource = '<?php echo (Helper::checkActionPermission('admin','home-tag-collection-edit')) ? '/admin/home-tag-collection-edit' : ''; ?>';
    var product = '<?php echo (Helper::checkActionPermission('admin','home-tag-collection-product')) ? '/admin/home-tag-collection-product' : ''; ?>';
    ...
    $(document).ready(function () {
         dTable = $('#HomeSliderList').dataTable({
            ...
            ajax: {
                url: '/admin/HomeTagCollectionListAjax/',
                data: function (d) {
