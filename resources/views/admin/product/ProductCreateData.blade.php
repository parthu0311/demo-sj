...
<div class="row Main_div_dropzone" id="Main_div_dropzone">
                            ...
                            @if($val['field_type'] == 'Radio-btn')
                                <div class="col-xs-12 col-sm-6 col-md-4 form-group redio Radio-btn "  data-field_label_id="{{$val['id']}}" data-is_variant="{{$val['is_show_tooltip']}}">
                                    <div  class="main-div">
                                        ...
                                        <label for="label">{{$val['field_label']}}</label><span class="is_required asterisk red"><?php if($val['is_required'] == 'Yes'){ echo '*'; } ?></span>
