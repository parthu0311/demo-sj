...
<html lang="en">
    <head>
        ...
        <!---Title-->
        <title>Galleria - Comming Soon</title>
        <!--Google Fonts-->
        ...
        <!--Meanmenu CSS-->
        <link href="{{asset("front/css/meanmenu.min.css")}}" rel="stylesheet">
        <!--Rev Slider CSS-->
    ...
    <body class="c-soon">
        ...
        <section class="comming-soon-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="c-soon-image-text">
                            <div class="logo">
                                <a href="#"><img src="{{asset("front/img/c-soon-logo.png")}}" alt=""></a>
                            </div>
        ...
        <!--End of Commingsoon Area-->
        <!-- jQuery js-->
        <script src="{{asset("front/js/vendor/jquery-1.11.3.min.js")}}"></script>
        <!--Bootsrap-->
        ...
        <script src="{{asset("front/rs-plugin/js/jquery.themepunch.activate.js")}}"></script>
        <!--Scroll Up js-->
        ...
        <!--jQuery Throttle js-->
        <script src="{{asset("front/js/jquery.throttle.js")}}"></script>
